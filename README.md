...
![](README_files/figure-html/TF_plot1-1.png)<!-- -->
...
![](README_files/figure-html/TF_plot2-1.png)<!-- -->
...
![](README_files/figure-html/TF_xb-1.png)<!-- -->
...
![](README_files/figure-html/TF_xb_plot-1.png)<!-- -->
...
![](README_files/figure-html/sim_topview-1.png)<!-- -->
...
* Vertical section along the line `lv`:
    ...
    ![](README_files/figure-html/vsec-1.png)<!-- -->
...
* Vertical section along the line `lh`:
    ...
    ![](README_files/figure-html/vsec_lh-1.png)<!-- -->
...
* Vertical section along the line `l`:
    ...
    ![](README_files/figure-html/vsec_l-1.png)<!-- -->
...
![](README_files/figure-html/HK_cube-1.png)<!-- -->
